...
// 12345,67 (PL: przecinek, bez spacji tysi�cy)
function toPL(x: any) {
...
// "15,20 %" jako TEKST dla Excela (nie zamieni na dat�)
...
export async function GET() {
    ...
    const header = ["Nr oferty", "Tytu�", "Odbiorca", "Warto�� netto", "Warto�� koszt�w", "Zysk", "Mar�a", "Etap", "Utworzono"];
    const out: string[] = [];
